...
var ASM_CONSTS = {
 ...
 72524: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 72595: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 72652: () => { return window.mouseX || 0; },  
 72683: () => { return window.mouseY || 0; },  
 72714: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 72861: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 72914: () => { return window.innerWidth; },  
 72944: () => { return window.innerHeight; },  
 72975: () => { Module.requestFullscreen(false, true); },  
 73014: () => { Module.exitFullscreen(false, true); },  
 73050: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
